...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    //For proper description of validation errors, when methods with @Valid are triggered
    @Override
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        List<ObjectError> vaidationErrorsList = ex.getBindingResult().getAllErrors();

        vaidationErrorsList.forEach((error) -> {
